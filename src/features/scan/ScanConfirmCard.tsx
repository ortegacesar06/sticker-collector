  ...
  return (
    <div className="absolute inset-x-0 bottom-0 bg-white rounded-t-2xl shadow-2xl p-4 animate-slide-up">
      ...
      <div className="flex gap-4">
        ...
        <div className="w-20 h-28 bg-gradient-to-br from-pitch to-pitch/80 rounded-lg flex flex-col items-center justify-center text-white">
        ...
        <div className="flex-1">
          <div className="flex items-start justify-between">
            <div>
              <h3 className="font-semibold text-ink text-lg leading-tight">{sticker.name}</h3>
      ...
      <div className="flex gap-3 mt-4">
        <button
          onClick={onDiscard}
          className="flex-1 py-3 rounded-lg bg-surface text-ink font-medium active:scale-95 transition-transform"
        >
          Descartar
        </button>
        <button
          onClick={onCorrect}
          className="flex-1 py-3 rounded-lg bg-accent-2 text-white font-medium active:scale-95 transition-transform"
        >
          Corregir
        </button>
        <button
          onClick={onConfirm}
          className="flex-1 py-3 rounded-lg bg-pitch text-white font-medium active:scale-95 transition-transform"
        >
